...
app.get("/api/subscribe", async (req, res) => {
  ...
  const session = await stripeConfig.checkout.sessions.create({
    ...
    success_url: `https://talkative-mu.vercel.app/success?plan=${plan}`,
    cancel_url: "https://talkative-mu.vercel.app/cancel",
  });
...
app.get("/api/subscriptions", async (req, res) => {
  ...
  const sub = await Subscription.findOne({ userEmail: req.query.email })
